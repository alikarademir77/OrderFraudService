...
import ca.bestbuy.orders.fraud.model.client.orderdetails.Bundle;
import ca.bestbuy.orders.fraud.model.client.orderdetails.FSOrderLineStatus;
import ca.bestbuy.orders.fraud.model.client.orderdetails.ItemCharge;
import ca.bestbuy.orders.fraud.model.client.orderdetails.Product;
...
public class FSOrderLine {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bundle, etaDate, id, itemCharge, lineNumber, product, qtyCancelled, qtyOnSpecialOrder, qtyOrdered, releaseDate, status, uom);
  }
