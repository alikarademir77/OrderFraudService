...
ALTER TABLE FRAUD_RQST_STATUS_HSTRY_DTLS ADD CONSTRAINT FRD_RQST_STATUS_HSTRY_DTLS_PK PRIMARY KEY ( FRAUD_RQST_STATUS_HSTRY_DTL_ID ) USING INDEX TABLESPACE ORDERFRAUD_INDEX;
