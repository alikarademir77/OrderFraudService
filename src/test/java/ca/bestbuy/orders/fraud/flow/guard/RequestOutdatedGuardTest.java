...
@DirtiesContext
public class RequestOutdatedGuardTest {

	@Mock(answer = Answers.RETURNS_DEEP_STUBS)
	StateContext<FlowStates, FlowEvents> context;
	
	@Test
	public void testEvaluateForRequestOutdated(){
		...
		RequestOutdatedGuard guardObj = new RequestOutdatedGuard();
		assertTrue(guardObj.evaluate(context));
	}

	@Test
	public void testEvaluateForRequestNotOutdated(){
		String orderNumber = "123456";
		long requestVersion = 1;
