...
DROP TABLE ORDER_FRAUD.FRAUDREQUESTHISTORY IF EXISTS;
CREATE TABLE ORDER_FRAUD.FRAUDREQUESTHISTORY (
...
ALTER TABLE ORDER_FRAUD.FRAUDREQUESTHISTORY ADD CONSTRAINT FRAUDREQUESTHISTORY_PK PRIMARY KEY ( FRAUDREQUESTHISTORYID );

DROP TABLE ORDER_FRAUD.FRAUDREQUESTHISTORYDETAILS IF EXISTS;
CREATE TABLE ORDER_FRAUD.FRAUDREQUESTHISTORYDETAILS (
    FRAUDREQUESTHISTORYID   NUMBER NOT NULL,
...
ALTER TABLE ORDER_FRAUD.FRAUDREQUESTHISTORYDETAILS ADD CONSTRAINT FRAUDREQUESTHISTORYDETAILS_PK PRIMARY KEY ( FRAUDREQUESTHISTORYID );
...
ALTER TABLE ORDER_FRAUD.FRAUDREQUESTHISTORY 
...
ALTER TABLE ORDER_FRAUD.FRAUDREQUESTHISTORYDETAILS
