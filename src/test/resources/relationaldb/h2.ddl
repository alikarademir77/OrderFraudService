DROP TABLE FRAUDREQUEST IF EXISTS;
...
ALTER TABLE FRAUDREQUEST ADD CONSTRAINT FRAUDREQUEST_UN UNIQUE ( ORDERNUMBER, REQUESTVERSION );

DROP TABLE FRAUDREQUESTHISTORY IF EXISTS;
...
DROP TABLE FRAUDREQUESTHISTORYDETAILS IF EXISTS;
...
DROP TABLE FRAUDSTATUSES IF EXISTS;
...
DROP TABLE FRAUDREQUESTTYPES IF EXISTS;
...
DROP SEQUENCE FRAUDREQUEST_SEQ IF EXISTS;
CREATE SEQUENCE FRAUDREQUEST_SEQ START WITH 1 NOCACHE ORDER;

DROP SEQUENCE FRAUDREQUESTHISTORY_SEQ IF EXISTS;
CREATE SEQUENCE FRAUDREQUESTHISTORY_SEQ START WITH 1 NOCACHE ORDER;

DROP SEQUENCE FRAUDREQUESTHISTORYDETAILS_SEQ IF EXISTS;
